pipeline {
    ...
    environment {
        // Global Vars
        NAMESPACE_PREFIX="demo-ccsd"
        GITLAB_DOMAIN = "github.cm"
        GITLAB_USERNAME = "rht-ccsd"

        PIPELINES_NAMESPACE = "${NAMESPACE_PREFIX}-cicd"
        APP_NAME = "todolist"
        ...
        GIT_CREDENTIALS = credentials("${NAMESPACE_PREFIX}-cicd-gitlab-auth")
    }
            ...
            post {
                ...
                success {
                    ...
                    sh'''
                        ...
                        git push http://${GIT_CREDENTIALS_USR}:${GIT_CREDENTIALS_PSW}@${GITLAB_DOMAIN}/${GITLAB_USERNAME}/${APP_NAME}.git --tags
                    '''
                }
                failure {
                    echo "FAILURE"
